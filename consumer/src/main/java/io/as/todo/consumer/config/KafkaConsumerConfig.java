...
public class KafkaConsumerConfig
{
    ...
    public Map<String, Object> consumerProps()
    {
        ...
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, toDoProperties.getKafka().getBootstrap());
        props.put(ConsumerConfig.GROUP_ID_CONFIG, toDoProperties.getKafka().getGroup());
